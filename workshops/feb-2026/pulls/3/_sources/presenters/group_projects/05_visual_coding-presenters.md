...
This notebook can be downloaded as **{nb-download}`05_visual_coding-presenters.ipynb`**. See the button at the top right to download as markdown or pdf.
:::
...
This notebook has had all its explanatory text removed and has not been run.
 ...
 rendered of this notebook, go [here](../../full/group_projects/05_visual_coding.md)
