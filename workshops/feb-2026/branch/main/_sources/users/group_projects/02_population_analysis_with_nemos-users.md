...
This notebook can be downloaded as **{nb-download}`02_population_analysis_with_nemos-users.ipynb`**. See the button at the top right to download as markdown or pdf.
:::
