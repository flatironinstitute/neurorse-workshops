...
This notebook can be downloaded as **{nb-download}`02_01_place_cells_1d_neural_tuning-presenters.ipynb`**. See the button at the top right to download as markdown or pdf.
:::
...
This notebook has had all its explanatory text removed and has not been run.
 ...
 rendered of this notebook, go [here](../../../full/group_projects/02_place_cells/02_01_place_cells_1d_neural_tuning.md)
