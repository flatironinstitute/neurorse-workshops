...
This notebook can be downloaded as **{nb-download}`02_03_place_cells_2d_neural_tuning-users.ipynb`**. See the button at the top right to download as markdown or pdf.
:::
