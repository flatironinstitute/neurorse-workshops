...
This notebook can be downloaded as **{nb-download}`02_02_place_cells_signal_processing-users.ipynb`**. See the button at the top right to download as markdown or pdf.
:::
# Signal processing
